...
const SUPABASE_SERVICE_KEY = "sb_publishable_C17rSvnbWuNUDLoSJJZ28w_qjRsQnCG";
...
const DUMMY_PRODUCTS = [
  ...
  ...generateProducts(
    ...
    ['Classic White T-Shirt', 'Vintage Denim Jacket', 'Summer Floral Dress', 'Comfortable Running Sneakers'], 
    799
  ),
  // Electronics
  ...generateProducts(
    ...
    ['Noise Cancelling Headphones', 'Smart Fitness Watch', 'Portable Bluetooth Speaker', 'Fast Charging Power Bank'], 
    1499
  ),
  // Beauty
  ...generateProducts(
    ...
    ['Hydrating Face Serum', 'Long-Lasting Matte Lipstick', 'Revitalizing Night Cream', 'Volumizing Mascara'], 
    499
  ),
  // Home
  ...generateProducts(
    ...
    ['Ceramic Coffee Mug Set', 'Cozy Throw Blanket', 'Minimalist Table Lamp', 'Cotton Bed Sheets'], 
    599
  ),
  // Auto
  ...generateProducts(
    ...
    ['Premium Car Air Freshener', 'Microfiber Cleaning Cloths', 'Dashboard Phone Mount', 'Leather Seat Covers'], 
    299
  ),
  // Sports
  ...generateProducts(
    ...
    ['Non-Slip Yoga Mat', 'Adjustable Dumbbell Set', 'Heavy Duty Resistance Bands', 'Steel Water Bottle'], 
    699
  ),
];
